...
<head>
  ...
  <title>Kaxyz_Id</title>
  <meta name="description" content="">
  <meta name="keywords" content="">

  <!-- Favicons -->
  <link href="{{ asset('assets/img/a.jpg') }}" rel="icon">
<link href="{{ asset('assets/img/apple-touch-icon.png') }}" rel="apple-touch-icon">

  <!-- Fonts -->
  <link href="https://fonts.googleapis.com" rel="preconnect">
  <link href="ttps://fonts.gstatic.com" rel="preconnect" crossorigin>
    ...
    <section id="clients" class="clients section">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="swiper-wrapper align-items-center">
            ...
            <div class="swiper-slide">
                <img src="{{ asset('assets/img/clients/client-7.png') }}" class="img-fluid" alt="Client 7">
            </div>
            <div class="swiper-slide">
                <img src="{{ asset('assets/img/clients/client-8.png') }}" class="img-fluid" alt="Client 8">
            </div>
        </div>
        ...
        <div class="tab-content" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="tab-pane fade" id="tabs-tab-3">
            <div class="row">
              ...
              <div class="col-lg-6 order-1 order-lg-2 text-center">
                <<img src="{{ asset('assets/img/working-3.jpg') }}" alt="Working 3" class="img-fluid">
          ...
          <div class="tab-pane fade" id="tabs-tab-4">
            <div class="row">
              ...
              <div class="col-lg-6 order-1 order-lg-2 text-center">
                <img src="{{ asset('assets/img/working-4.jpg') }}" alt="Working 4" class="img-fluid">
              </div>
            </div>
          </div><!-- End Tab Content Item -->
        ...
        <div class="isotope-layout" data-default-filter="*" data-layout="masonry" data-sort="original-order">
          ...
          <div class="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-books">
              <div class="portfolio-content h-100">
                <img src="{{ asset('assets/img/portfolio/books-1.jpg') }}" class="img-fluid" alt="Books 1">
                <div class="portfolio-info">
                  <h4>Books 1</h4>
                  <p>Lorem ipsum, dolor sit amet consectetur</p>
